---
title: 'R Notebook: Data Audit for [Gabriel Tessema]'
output:
  html_document:
    df_print: paged
    toc: yes
...
## Set your WSU id
```{r}
wsu.id = "11692347"; # change this to yours.
```

### Set your path to secret
```{r}
path.to.secret = "https://github.com/Gabetes/WSU_STATS419_2020";
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- I haven't fabricated any of the data that I used for this project --
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- None of my peers asked me to fabricate data --
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- since they didn't follow the rules of intergrity at WSU they should get penalized --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- They should lose points for the project --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- I was actively following the Discord group that was created for this class. --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
--Not only technical skills but now I have a picture of what is waiting for me in the future of Data analysis --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- Github was difficult for me because I haven't spent a lot of time on it --
</pre>

## Describe your progress in understanding the language of "data analytics."

<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- this class made me love Data analytics even more because it exposed me to things that I would tackle in the field  --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
--I was very interested on data cleansing and data organizing. The idea of garbage in garbage out really bothers me so when I see bad data I always try to make it better. --
</pre>
...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- I found this class to be difficult for various reasons I am an international student from Ethiopia,English is not my first language therefore I struggled on delivering what was needed on the assignments. And unfortunaltey I tested positive for Covid-19 which made it very much easier because I spent almost 10days in the hospital.  am working on my English and my coding skills as I go through.--
</pre>

## Final comments you would like to share.

<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
-- Thank you very much for opening us up for new ideas and critical thinking. Most of us needed this class because it helps us see what is expected from us not only in class but in a working environmnent. --
</pre>
